...
## 猜测
科班出身的人一定做过不少quiz,这也就能够解释科班出身的人为何比非科班出身的人水平要好了.
...
###  learning by doing
所谓"learning  by doing " 就是通过做一个实际的项目或者说解决问题来学习,也就是做种学. 包括但不限于: 
...
* **时间消耗大**
    ...
    > 若是来解决一个大中型项目中的问题来提升编程水平就要花费大量的数周的时间来熟悉项目;
* **无法判断质量**

    > 这个过程没有一个较为标准的答案进行对比,导致我只能判断问题有没有解决,却不能通过看一个较标准的答案来判断自己代码的好坏;
...
> 做当练习题是好的练习题时,做练习题不但具备上述两种常见思路的益处,而且还没有上述两个思路存在的问题.
...
* **可通过阅读参考答案代码学习**
    > 有参考答案可以对比自己代码的优劣,学习他人的思路,与使用ruby描述问题解决方案的方法;
